...
export default class LoadScene extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.image(CST.ASSETS.SHIPS.ENEMY_BULLET, "src/assets/red_bullet.png");
    ...
    this.load.image(CST.ASSETS.EXTRAS.MED_ASTROID, "src/assets/meteor_med.png");
    ...
    this.load.audio(CST.ASSETS.SHIPS.LASER_AUDIO, "src/assets/laser_audio.ogg");

    this.load.image(CST.ASSETS.EXTRAS.TURRET, "src/assets/turret.png");
    ...
    this.load.audio(CST.ASSETS.EXTRAS.BOOST_AUDIO, "src/assets/powerup.mp3");
